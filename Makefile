...
machines.js: js/match.js js/compiledMatch.js js/sandbox.js js/step.js js/prof.js driver.js Makefile
	cat  js/prof.js js/match.js js/compiledMatch.js js/sandbox.js js/step.js driver.js > machines.js

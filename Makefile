...
machines.js: js/match.js js/sandbox.js js/step.js js/prof.js js/compiledMatch.js driver.js Makefile
	cat js/match.js js/sandbox.js js/step.js js/prof.js js/compiledMatch.js driver.js > machines.js
